...
export const createSearchResultBundle = (): IResource => ({
  resourceType: 'Bundle',
  id: 'bd15a1c0-748b-409c-a71a-e09b6dbbabf8',
  meta: { lastUpdated: '2018-01-06T22:18:21.779+01:00' },
  type: 'searchset',
  total: 200,
  link: [
    {
      relation: 'self',
      url:
        'http://localhost:8080/baseDstu3/Observation?subject=Patient%2F47528',
    },
    {
      relation: 'next',
      url:
